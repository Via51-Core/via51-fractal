  ...
  const sections = [
    {
      id: "01",
      title: { 
        ES: "1. El Virus del Abandono (PolÃ­tico): La Vacuna contra el Futuro", 
        QU: "1. Saqerpayaypa unquynin (polÃ­tica): Hamuq pachapaq t'uksiy", 
        EN: "1. The Virus of Abandonment (Political): The Vaccine against the Future" 
      },
      content: { 
        ES: "Desde nuestra infancia, una infecciÃ³n invisible ha recorrido el sistema nervioso del PerÃº. Se nos ha 'vacunado' con una frase que parece prudencia pero es veneno: 'Ni te metas en polÃ­tica, porque la polÃ­tica es de lo peor'. Este es el Virus del Abandono. Su objetivo no es protegernos, sino que abandonemos el escenario para que las fuerzas perniciosas ocupen el Punto de Origen de la voluntad nacional. Al abandonar la polÃ­tica, hemos permitido el 'descopamiento' de las elites pro-bien comÃºn, dejando el timÃ³n del paÃ­s en manos de una incompetencia filtrada y premeditada. En VIA51, declaramos que rescatar la polÃ­tica del abandono es nuestra primera urgencia.",
        QU: "Warmacha kasqanchikmantapacha, mana rikuna unquymi Perupa sirk'ankunapi puriykun. 'Amam politicaman yaykunkichu, chayqa mana allinmi' nispa t'uksiwarqanchik. Kayqa Saqerpayaypa Unquyninmi. Manam amachawasqanchikpaqchu, aswanpas politicata saqenanchikpaqmi, chaynapi mana allin runakuna kamachinankupaq. PolÃ­ticata saqespa, allin ruraq runakunatam qarqonku, chaynapi mana yachayniyoq runakuna kikinpa munasqallanpaq kamachinankupaq. VIA51-piqa nikuikum: polÃ­tica saqeytaqa tukunanchikmi, chaymi allinchananchik Ã±awpaqtaqa.",
    ...
    },
    {
      ...
      content: { 
        ES: "El PerÃº ya ha sido potencia mundial en oro, plata, guano, pesca, hierro y cobre. Sin embargo, esa 'potencia' solo ha dejado un rastro de exterminio y pobreza extrema. Ser una 'potencia en cosas' no sirve de nada si no somos una Potencia en Bienestar. VIA51 propone una SoberanÃ­a de Desarrollo de Calidad Mundial en una sola generaciÃ³n.",
        QU: "Peruqa Ã±awpaq k'anchariqmi karqan qoripi, qolqepi, wanupi, challwakunapipas... ichaqa chay llimp'iyuq kayqa wakcha kayllatam llaqtapaq saqerqan. 'Imakunallapi' kallpayuq kayqa manam valenchu, mana sapa runa allin kawsaypi kaptinqa. VIA51 nisqaykuqa huk wiÃ±ayllapim lliw pachapaq allin kawsayta paqarichimunqa.",
    ...
    <div style={{ backgroundColor: '#050505', color: '#ffffff', minHeight: '100vh', padding: '40px', fontFamily: 'sans-serif' }}>
      <div style={{ maxWidth: '850px', margin: '0 auto' }}>
        ...
        <main>
          ...
          {/* MANTRA DE TRANSMUTACIÃ“N - MÃXIMA NITIDEZ */}
          <section style={{ backgroundColor: '#D4AF37', color: '#000', padding: '80px 50px', textAlign: 'center', marginTop: '120px', boxShadow: '0 30px 60px rgba(0,0,0,0.5)' }}>
             <h4 style={{ fontSize: '11px', textTransform: 'uppercase', letterSpacing: '0.6em', marginBottom: '35px', fontWeight: '900', opacity: 0.7 }}>Mantra de TransmutaciÃ³n</h4>
             <p style={{ fontSize: '34px', fontWeight: '900', textTransform: 'uppercase', lineHeight: '1', marginBottom: '0' }}>
               "{activeLang === 'ES' ? "No requerimos tu voto, solicitamos tu atenciÃ³n deliberada. Te invitamos a transmutar tu mentalidad; el bienestar de clase mundial nace en el momento en que decides ver el fractal completo." : 
                 activeLang === 'QU' ? "Manam votoykitachu munayku, yuyayniykita chaskinaykutam munayku. Ã‘awinchikta kicharisun pacha t'ikranapaq; allin kawsayqa yuyayninchikpi qallarin." :
